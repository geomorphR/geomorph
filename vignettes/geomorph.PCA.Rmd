...
summary(phylo.PCA)
plot(phylo.PCA, phylo = T, main = "phylo PCA")
```
...
```{r eval=TRUE}
plot(PCA.w.phylo, time.plot = T, pch = 22, bg = c(rep("red", 5), rep("green", 4)), cex = 2, 
