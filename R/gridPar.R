...
#'
#' Function produces a list of parameter changes within plotRefToTarget (2D only)
#'
#' The function allows users to vary certain plotting parameters to produce different
#' graphical outcomes for plotRefToTarget.  Not all parameters need to be adjusted to use this
