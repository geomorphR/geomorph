...
#' function might be used to comapre levels of integration between two or more samples, each measuring morphological 
...
#'  
#'  To use thsi function, simply perform \code{\link{two.b.pls}}, \code{\link{integration.test}}, or 
