...
#' replicate = replicate, object.sym = FALSE, RRPP = TRUE, iter = 249, data = gdf)
...
#' land.pairs = lizards$lm.pairs, data = gdf, RRPP = TRUE, iter = 249)
#' summary(liz.sym)
#' 
...
#' land.pairs=scallops$land.pairs, data = gdf, RRPP = TRUE, iter = 249)
#' summary(scallop.sym)
