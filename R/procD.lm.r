...
#' 
#' PW <- pairwise(fit.full, fit.null = fit.null, groups = gp, covariate = NULL)
#' 
...
#' morphol.disparity(fit.full, groups = gp)
#' 
#' ### Regression example
#' data(ratland)
...
#' 
#' fit <- procD.lm(coords ~ Csize, data = gdf, iter = 999, RRPP = TRUE) # randomize raw values
#' summary(fit)
#' 
