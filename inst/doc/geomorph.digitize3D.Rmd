...
vignette: >
  %\VignetteIndexEntry{geomorph version 3.1.1 Synopsis}
...
knitr::include_graphics("fixed.3D.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
knitr::include_graphics("example_template.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
knitr::include_graphics("example_spec2.png")  
```
