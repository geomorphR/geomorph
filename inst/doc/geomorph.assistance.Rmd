...
vignette: >
  %\VignetteIndexEntry{geomorph Assistance}
...
nested.anova | deprectaed | anova (*RRPP*) (Can do much more than nested.anova could)
...
This vignette hopefully illustrates that the goals of former functions - advanced.procD.lm, procD.allometry, and nested.anova - are as easily accomplished with alternative functions that have fewer constraints.  If you are new to geomorph, then this vignette should give you some ideas for how to analyze data with pairwise comparisons.
